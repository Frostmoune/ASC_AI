...
def main():
    ...
    parser.add_argument('--split', type = str, default = 'train',
                        help = 'train/val/test')
    parser.add_argument('--model_path', type = str, default = './Data/ResNet/resnet_v2_101.ckpt',
            ...
            with tf.Session() as sess:
                while idx < length:
                    ...
                    with slim.arg_scope(resnet.resnet_arg_scope()):
                        logits, end_points = resnet.resnet_v2_101(image_batch[0:count, :, :, :], num_classes = None, is_training = False, reuse = tf.AUTO_REUSE)
                        if not flag:
                    ...
                    if idx % 10 == 0:
                        res5c_batch = res5c_batch[0].reshape((args.batch_size, 2048))
                    else:
                        res5c_batch = res5c_batch[0].reshape((idx % args.batch_size, 2048))
